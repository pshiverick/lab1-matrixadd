...
#error "unknown OpenCL SDK environment"
    ...
    clSetKernelArg(kernel, 6, sizeof(cl_mem), (void *)&bufferA);
    clSetKernelArg(kernel, 7, sizeof(cl_mem), (void *)&bufferB);
		clSetKernelArg(kernel, 8, sizeof(cl_mem), (void *)&bufferC);
